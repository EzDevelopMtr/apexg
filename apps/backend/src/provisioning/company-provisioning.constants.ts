...
export const MEMBERSHIP_TYPE_SEED: readonly MembershipTypeSeed[] = [
  ...
  },
  {
    ...
    // días"); resuelto a favor de §4.1. Sin validación automática de
    // grupo todavía (`promotion_groups` existe en el esquema, sin usar).
    name: 'Promo amigos/familiar',
    price: '60000',
    description:
      'Tarifa por persona para grupos de tres o más clientes que pagan juntos dentro de un lapso de 3 días',
    durationValue: 1,
    durationUnit: 'month',
    minimumPayment: null,
    trainerShare: null,
