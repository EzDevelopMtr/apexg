...
@Module({
  ...
  exports: [
    ...
    AuthorizationService,
    PermissionGuard,
    // AccessTokenGuard depende de JwtService: sin reexportar JwtModule, un
    // módulo de negocio que importe AuthModule para reusar el guard no
    // puede resolver esa dependencia ("JwtService... available in
    // <ModuloConsumidor>"). Necesario para que otros módulos reutilicen el
    // guard, que es justamente para lo que este módulo lo exporta.
    JwtModule,
  ],
})
