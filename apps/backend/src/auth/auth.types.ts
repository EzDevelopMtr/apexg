 ...
 *
 * `roleName` (p. ej. "Administrador") es SOLO para que el frontend elija qué
 * mostrar — nunca para autorizar. Cada ruta sigue decidiendo acceso con
 * `AuthorizationService.hasPermissions(companyId, roleId, codes)`, no
 * comparando este nombre.
 */
