...
import { clientesIniciales, tituloSeccionClientes } from "@apexg/core";
...
export default function Clientes({
  ...
  */
  ...
  /*
    Los titulos ahora viven en @apexg/core para que
    la sidebar, las rutas y esta pagina usen los
    mismos textos.
  */
